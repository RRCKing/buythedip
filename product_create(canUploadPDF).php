<?php
    ...
    include '\xampp\htdocs\buythedip\lib\ImageResize.php';
    include '\xampp\htdocs\buythedip\lib\ImageResizeException.php';
    ...
    if ($_POST && !empty($_POST['product_desc'])) {
        ...
        // Add Product query
        $addProduct = "INSERT INTO products (Product_Desc, Category_ID) 
                    VALUES (:product_desc, :category_id)";
        ...
        if($productStatement->execute()){
            ...
            // one function for allowed file check, can combine with file_is_an_image if have more time.
            ...
            if ($image_upload_detected) { 
                ...
                // This is for checking whether the files are PDF or images
...
<body>
    ...
    <?php if ($invalid_file): ?>
        <p>File type invalid, only '.jpg', 'jpeg', '.png', '.gif', and '.pdf' allowed.</p>
    <?php endif ?>
